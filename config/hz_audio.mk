...
ALARM_PATH := vendor/hz/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/hz/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/hz/prebuilt/common/media/audio/ringtones
