...
HZ_VERSION := HZOS-v$(HZVERSION)-$(HZ_CODENAME)-$(HZ_BUILD_DATE)-$(HZ_BUILD)-$(HZ_BUILD_TYPE)-GApps
else
HZ_VERSION := HZOS-v$(HZVERSION)-$(HZ_CODENAME)-$(HZ_BUILD_DATE)-$(HZ_BUILD)-$(HZ_BUILD_TYPE)-Vanilla
endif
...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += \
    ...
    ro.hz.battery?=$(HZ_BATTERY) \
    ro.hz.chipset?=$(HZ_CHIPSET) \
